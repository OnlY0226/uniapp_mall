		...
		<view class="cate-mask" :class="cateMaskState===0 ? 'none' : cateMaskState===1 ? 'show' : ''" @click="toggleCateMask">
			<view class="cate-content" @click.stop.prevent="stopPrevent" @touchmove.stop.prevent="stopPrevent">
				<scroll-view scroll-y class="cate-list">
					<view v-for="item in goodTypeList" :key="item.id">
						<view class="cate-item b-b two" :class="{active: tItem.id==goodTypeId}" @click="changeCate(item)">{{item.cname}}</view>
						<!-- <view v-for="tItem in item.child" :key="tItem.id" class="cate-item b-b" :class="{active: tItem.id==goodTypeId}"
