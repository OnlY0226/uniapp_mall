	...
	<view class="container">
		...
		<view class="user-section">
			...
			<view class="user-info-box">
				...
				<view class="login-box"  v-show="isShowLoginBtn">
					<button class="login-btn" open-type="getUserInfo" @getuserinfo="wxGetUserInfo" lang="zh_CN" withCredentials="true">登陆</button>
				</view>
			</view>
